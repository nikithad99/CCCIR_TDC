...
C {devices/ipin.sym} 60 -400 0 0 {name=p3 lab=in}
C {devices/opin.sym} 40 -120 0 0 {name=p5 lab=out}
C {devices/iopin.sym} 40 -40 0 0 {name=p2 lab=VSS}
C {devices/ipin.sym} 60 -320 0 0 {name=p9 lab=t0}
C {devices/ipin.sym} 60 -280 0 0 {name=p15 lab=t1}
...
C {devices/lab_pin.sym} 520 -410 0 1 {name=p11 sig_type=std_logic lab=and_pwr}
C {devices/lab_pin.sym} 520 -510 0 1 {name=p13 sig_type=std_logic lab=and_pwr}
C {devices/ipin.sym} 60 -240 0 0 {name=p14 lab=t2}
C {devices/ipin.sym} 60 -200 0 0 {name=p16 lab=t3}
...
C {devices/ipin.sym} 60 -360 0 0 {name=p22 lab=en}
...
C {devices/ipin.sym} 60 -160 0 0 {name=p25 lab=and_pwr}
