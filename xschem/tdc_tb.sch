...
.tran 0.001n 200n
.save v(start) v(stop) v(term_0) v(term_1) v(term_2) v(term_3) v(term_4) v(term_5) v(term_6) v(term_7) v(x1.start_pos) v(x1.start_neg) v(x1.stop_strong) v(x1.delay_pos_0) v(x1.delay_neg_0) v(x1.delay_pos_1) v(x1.delay_neg_1) v(x1.delay_pos_2) v(x1.delay_neg_2) v(x1.delay_pos_3) v(x1.delay_neg_3) v(x1.delay_pos_4) v(x1.delay_neg_4) v(x1.delay_pos_5) v(x1.delay_neg_5) v(x1.delay_pos_6) v(x1.delay_neg_6) v(x1.delay_pos_7) v(x1.delay_neg_7)

.control
run
set wr_vecnames
wrdata tdc_tb.txt v(start) v(stop) v(term_0) v(term_1) v(term_2) v(term_3) v(term_4) v(term_5) v(term_6) v(term_7) v(x1.start_pos) v(x1.start_neg) v(x1.stop_strong) v(x1.delay_pos_0) v(x1.delay_neg_0) v(x1.delay_pos_1) v(x1.delay_neg_1) v(x1.delay_pos_2) v(x1.delay_neg_2) v(x1.delay_pos_3) v(x1.delay_neg_3) v(x1.delay_pos_4) v(x1.delay_neg_4) v(x1.delay_pos_5) v(x1.delay_neg_5) v(x1.delay_pos_6) v(x1.delay_neg_6) v(x1.delay_pos_7) v(x1.delay_neg_7)
.endc
"}
