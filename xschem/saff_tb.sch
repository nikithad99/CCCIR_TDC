...
.tran 0.001n 50n
.save v(d) v(nd) v(clk) v(q) v(nq) v(x1.left_latch_1) v(x1.right_latch_1) v(x1.left_latch_2) v(x1.right_latch_2)

.control
run
set wr_vecnames
wrdata saff_tb.txt v(d) v(nd) v(clk) v(q) v(nq) v(x1.left_latch_1) v(x1.right_latch_1) v(x1.left_latch_2) v(x1.right_latch_2)
.endc
"}
