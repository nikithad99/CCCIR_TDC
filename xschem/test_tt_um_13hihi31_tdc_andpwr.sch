...
save v(in) v(term_0) v(term_1) v(term_2) v(term_3) v(term_4) v(term_5) v(term_6) v(term_7) v(start) v(analog_input) v(x1.stop) v(x1.start) v(x1.stop_delayed) v(x1.start_delayed)
set wr_vecnames
wrdata test_tt_um_13hihi31_tdc_andpwr v(in) v(term_0) v(term_1) v(term_2) v(term_3) v(term_4) v(term_5) v(term_6) v(term_7) v(start) v(analog_input) v(x1.stop) v(x1.start) v(x1.stop_delayed) v(x1.start_delayed)
