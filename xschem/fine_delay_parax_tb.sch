...
C {devices/gnd.sym} 460 -250 0 0 {name=l2 lab=GND}
C {devices/lab_pin.sym} 460 -270 0 1 {name=p1 sig_type=std_logic lab=vdd}
C {sky130_fd_pr/pfet_01v8.sym} 1120 -300 0 0 {name=M1
L=0.15
W=3
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 1120 -220 0 0 {name=M2
L=0.15
W=1
nf=1 
mult=1
...
C {devices/lab_pin.sym} 1140 -330 0 1 {name=p38 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 1100 -260 0 0 {name=p47 sig_type=std_logic lab=delay}
C {devices/gnd.sym} 1140 -190 0 0 {name=l3 lab=GND}
...
C {devices/lab_pin.sym} 160 -290 0 0 {name=p12 sig_type=std_logic lab=in}
C {devices/lab_pin.sym} 160 -270 0 0 {name=p14 sig_type=std_logic lab=en_1}
C {devices/lab_pin.sym} 160 -250 0 0 {name=p15 sig_type=std_logic lab=en_2}
...
save v(in) v(delay)
set wr_vecnames
wrdata fine_delay_parax_tb_$i v(in) v(delay)

end
.endc
"}
C {fine_delay.sym} 310 -270 0 0 {name=x1
...
C {devices/gnd.sym} 900 -250 0 0 {name=l8 lab=GND}
C {devices/lab_pin.sym} 900 -270 0 1 {name=p8 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 900 -290 0 1 {name=p9 sig_type=std_logic lab=delay}
C {devices/lab_pin.sym} 600 -270 0 0 {name=p17 sig_type=std_logic lab=en_3}
C {devices/lab_pin.sym} 600 -250 0 0 {name=p18 sig_type=std_logic lab=en_4}
C {fine_delay.sym} 750 -270 0 0 {name=x2
schematic=fine_delay_unit_parax.sim
spice_sym_def="tcleval(.include [file normalize ../mag/fine_delay_unit.sim.spice])"
tclcommand="textwindow [file normalize ../mag/fine_delay_unit.sim.spice]"}
