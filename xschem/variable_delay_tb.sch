...
C {devices/vsource.sym} 60 -90 0 0 {name=V1 value=1.8 savecurrent=false}
C {devices/lab_pin.sym} 60 -120 0 0 {name=p4 sig_type=std_logic lab=vdd}
C {devices/gnd.sym} 1080 -60 0 0 {name=l9 lab=GND}
C {devices/vsource.sym} 1080 -90 0 0 {name=V3 value="pulse(0 1.8 1ns 0.5ns 0.5ns 0.5ns 2ns)" savecurrent=false}
...
run
set wr_vecnames
wrdata variable_delay_7_tb.txt v(in) v(delay)
.endc
"}
