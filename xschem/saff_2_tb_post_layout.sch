...
C {saff_2.sym} 650 -150 0 0 {name=x6
schematic=saff_2_parax.sim
spice_sym_def="tcleval(.include [file normalize ../mag/saff_2.sim.spice])"
tclcommand="textwindow [file normalize ../mag/saff_2.sim.spice]"}
C {devices/lab_pin.sym} 500 -200 0 0 {name=p20 sig_type=std_logic lab=d}
C {devices/lab_pin.sym} 500 -180 0 0 {name=p26 sig_type=std_logic lab=nd}
C {devices/lab_pin.sym} 500 -160 0 0 {name=p39 sig_type=std_logic lab=clk}
C {devices/lab_pin.sym} 800 -200 0 1 {name=p40 sig_type=std_logic lab=q}
C {devices/lab_pin.sym} 800 -180 0 1 {name=p41 sig_type=std_logic lab=nq}
C {devices/lab_pin.sym} 860 -160 0 1 {name=p42 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 860 -120 0 1 {name=p43 sig_type=std_logic lab=vdd}
C {devices/gnd.sym} 800 -140 3 1 {name=l24 lab=GND}
C {devices/gnd.sym} 800 -100 3 1 {name=l25 lab=GND}
